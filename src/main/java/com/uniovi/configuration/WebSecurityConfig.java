	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable()
			.authorizeRequests()
				...
				.antMatchers("/homework/list/**").hasAnyAuthority("ROLE_PROFESSOR")
				.antMatchers("/user/student/list").hasAuthority("ROLE_PROFESSOR")
				.antMatchers("/user/student/search").hasAuthority("ROLE_PROFESSOR")
				.antMatchers("/homework/exercise/list/**").hasAnyAuthority("ROLE_STUDENT")
				...
				.antMatchers("/feedback/list").hasAuthority("ROLE_STUDENT")
				.antMatchers("/feedback/answer/**").hasAuthority("ROLE_STUDENT")
