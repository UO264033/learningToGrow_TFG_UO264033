...
import com.uniovi.validators.DoHomeworkTestValidator;
...
public class DoHomeworkController {
	...
	@Autowired
	private DoHomeworkTestValidator doHomeworkValidator;
	...
	public String savesHomeworkShortAnswer(Model model, @RequestParam(value = "idExercise") Long idExercise,
			@RequestParam(value = "answerStrings[]", required = false) String[] answerStrings, Principal principal,
	...
	public String savesHomeworkTest(Model model, @RequestParam(value = "idExercise") Long idExercise,
			@RequestParam(value = "checkAnswers[]", required = false) int[] checkAnswers, Principal principal,
			@RequestParam(value = "description", required = false) String description, @Validated Subject testVa,
